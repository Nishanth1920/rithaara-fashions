...
import { womenProducts, categories } from '../data/products'
...
const WomenCollection = () => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-primary-600 via-primary-500 to-primary-400 text-white py-20">
        <div className="section-container">
          ...
          >
            ...
            <p className="text-white/95 text-lg">
              Embrace elegance with our curated collection of contemporary and traditional designs
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-24">
              ...
              <div className="mt-8 p-6 bg-gradient-to-br from-primary-50 to-primary-100 rounded-lg">
                ...
                <p className="text-accent-600 text-sm mb-4">
                  Get personalized fashion recommendations from our experts
                </p>
                <a
      ...
      {/* CTA Section */}
      <section className="section-container bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl mx-4 sm:mx-6 lg:mx-8">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="heading-tertiary mb-4">
            Find Your Perfect Style
          </h2>
          <p className="text-accent-600 mb-6">
            Browse our complete collection on Instagram and get in touch to place your order
          </p>
          <a
